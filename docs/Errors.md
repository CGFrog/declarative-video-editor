...
<h3>"FileNotFoundError: [WinError 2] The system cannot find the file specified"</h3>
<p>Seeing this error when compiling your first video means FFmpeg is not installed properly. Please refer to the install guide found <a href ="Setup.md">here</a>.</p>
